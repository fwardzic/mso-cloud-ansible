...
print ("CA_ROOT_CERT_FILE:  " + str(CA_ROOT_CERT_FILE))
print ("THING_CERT_FILE:  " + str(THING_CERT_FILE))
print ("THING_PRIVATE_KEY:  " + str(THING_PRIVATE_KEY))
print ("----------------------------------------------")
print ("")
print ("----------------------------------------------")
...
# Open DB Connection
try:
	print "Main File: Trying to open DB Connection..."
	time.sleep(15)
	db_connection = Sensor_DB_Class(DB_HOST, DB_PORT, DB_USER, DB_PASSWORD, DB_NAME)
	print "Main File: Connected with DB..."
except:
	print ("Main File: Failed to connect to the DB. Please check the DB IP, Port and Password.")
	exit(1)
...
# HTTP Proxy Settings      <<----------
#=============================================================
import pahoV3_1.mqtt.client as mqtt
mqttc = mqtt.Client()
#import socks
#mqttc.proxy_set(proxy_addr="10.96.164.50", proxy_port=3128, proxy_type=socks.HTTP)
#=============================================================
...
print ("Main File: Trying to connect to AWS IoT Core...")
